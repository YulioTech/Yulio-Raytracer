...
namespace embree
{
	...
	protected:
		Vec2i imageSize; //!< Dimensions of the entire image.
	...
	/*! The sampler factory pre-computes samples for usage by multiple sampler threads. */
	...
	public:
		...
		std::vector<int> lightBaseSamples; //!< Base samples for light sample pre-computation.
