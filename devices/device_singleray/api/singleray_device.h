...
namespace embree
{
  ...
  public:
    ...
    *******************************************************************/
    ...
    RTPrimitive rtNewShapePrimitive(RTShape shape, RTMaterial material, const float* transform, bool faceCamera);
	...
	void rtUpdatePrimitive(RTScene scene, size_t slot, RTPrimitive prim, const Vector3f &camPos, const Vector3f &camUp);
    ...
    *******************************************************************/
	...
	void rtGetFloat3(RTHandle handle, const char* property, float &x, float &y, float &z);
	...
	void rtGetString(RTHandle handle, const std::string &property, std::string &str);
	...
	void rtGetTransform(RTHandle handle, const char* property, AffineSpace3f *transform);
