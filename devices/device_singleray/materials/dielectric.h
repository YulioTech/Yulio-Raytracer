...
namespace embree
{
	...
	public:
		...
		~Dielectric()
		{
			if (reflection_io) delete reflection_io;   reflection_io = nullptr;
			if (reflection_oi) delete reflection_oi;   reflection_oi = nullptr;
			if (transmission_io) delete transmission_io; transmission_io = nullptr;
			if (transmission_oi) delete transmission_oi; transmission_oi = nullptr;
		}
